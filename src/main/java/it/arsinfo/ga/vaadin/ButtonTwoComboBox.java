...
public class ButtonTwoComboBox<T,S> extends UIChangeHandler {
    ...
    public ButtonTwoComboBox(String placeholder, List<T> tItems, List<S> sItems,String bcaption,VaadinIcons bicon) {
